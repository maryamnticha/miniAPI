    ...
    <div className="Cards">
      <Card style={{ width: "25em" }}>
        ...
        <Card.Body>
          ...
          <Card.Title> {company.bs} </Card.Title>
          <Card.Text>{`This is a the profile of ${name} from  the city of ${address.city}`}</Card.Text>
          <Card.Text>{`Working as  ${company.catchPhrase} in  ${company.name}`}</Card.Text>
